        ...
        <li>
            <div class="dropdown-menu dropdown-menu-head pull-right">
                <h5 class="title">日程备忘</h5>
                    ...
                    <li class="new"><a href="ware/imitation_2/dateworks.php">
                    		<span class="desc">
                              <span >进入日程管理</span>
                            </span>
                    </a></li>
        ...
        <li>
            <div class="dropdown-menu dropdown-menu-head pull-right">
                <h5 class="title">待处理文件</h5>
                    ...
                    <li class="new"><a href="remindTT.php">
                    		<span class="desc">
                              <span >进入提醒页面</span>
                            </span>
                    </a></li>
...
//          			$sqlC = "SELECT count(id) as Num  from  专案待缴费  where (费用状态=0 or 费用状态=1 or 费用状态=8) and 剩余天数<'10'";
            			$sqlC = "SELECT id from  专案待缴费  where (费用状态=0 or 费用状态=1 or 费用状态=8) and 剩余天数<'10'";
						$resultC = $conn->query($sqlC);
						if($resultC->num_rows>0){
							$Num4 = 0;
							while($rowC = $resultC->fetch_assoc()){
