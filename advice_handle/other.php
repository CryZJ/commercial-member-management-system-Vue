    	...
    	<header class="panel-heading custom-tab">
			<span class="tools pull-right">
	      	...
	      	<ul class="nav nav-tabs">
		        ...
		        <li class="active"><a href="#about-5" data-toggle="tab"><i class="fa fa-user"></i>其他文件</a></li>
                ...
                <section id="unseen">
					...
					<table class="display table table-bordered table-striped" id="other_table" style="font-size: 5px;">
				        ...
				        <?php
				        	...
				        	require("../conn.php");
									$sql = "SELECT id,上传时间,文件名称,通知书名称,通知书编码,专利名称,案卷号,原案卷号,申请号,申请日,发文日,申请号是否一样,案件存在 FROM ((SELECT id,上传时间,文件名称,通知书名称,通知书编码,专利名称,案卷号,原案卷号,申请号,申请日,发文日,申请号是否一样,案件存在 FROM 临时文件 WHERE 上传情况='0' AND 通知书编码<>'200101,200021' AND 通知书编码<>'200101,200103' AND 通知书编码<>'200602' AND 通知书编码<>'200701' AND 通知书编码<>'200702'AND 通知书编码<>'400002'AND 通知书编码<>'400003'AND 通知书编码<>'400001'  ORDER BY 上传时间 DESC) UNION (SELECT id,上传时间,文件名称,通知书名称,通知书编码,专利名称,案卷号,原案卷号,申请号,申请日,发文日,申请号是否一样,案件存在 FROM 临时文件 WHERE 上传情况='0' AND 案件存在='1' AND (通知书编码='200101,200021' OR 通知书编码='200101,200103' OR 通知书编码='200602' OR 通知书编码='200701' OR 通知书编码='200702') ORDER BY 上传时间 DESC)) AS c ORDER BY 上传时间";
