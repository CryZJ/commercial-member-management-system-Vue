                  ...
                  <section id="unseen">
					...
					//								if($admin==1){
												?>
													...
													<button class="btn btn-primary" href="#addModal5" data-toggle="modal" >批量修改案源人代理人</button>
												<?php
													}
												?>
		            <!-- button list end -->
	...
	//											print_r($checkdata);
	                	...
	                	<form action="#" method="post" id="Checkformdata">
	 											...
	 											<tr>
	 												...
	 												<td>
	 													<select name="checkdata[]">
	 														<option></option>
	 														<option selected="selected"><?php echo $checkdata[0]; ?></option>
	 														<option>发明专利</option>
	 														<option>实用新型</option>
	 														<option>外观设计</option>
	 													</select>
	 												...
	 												<td>
	 													<select name="checkdata[]">
	 														<option></option>
	 														<option selected="selected"><?php echo $checkdata[1]; ?></option>
	                        		...
	                        		<option value="结案">结案</option>
	 												...
	 												<td>案源人：</td>
	 												<td><input type="text" style="width: 60px;height: 20px;font-size: 5px;" name="checkdata[]" value="<?php echo $checkdata[2];?>" id="check_ayr" onclick="select_ayr(this.id)" readonly="readonly" /></td>
	 												<td>代理人：</td>
	 												<td><input type="text" style="width: 60px;height: 20px;font-size: 5px;" name="checkdata[]" value="<?php echo $checkdata[3];?>" id="check_dlr" onclick="select_dlr(this.id)" readonly="readonly" /></td>	 												 											
	 												<td>起始申请日：</td>
	 												<td><input type="date" style="height: 20px; width: 90px;font-size: 5px;" name="checkdata[]" value="<?php echo $checkdata[4];?>" /></td>
	 												<td>截止申请日：</td>
	 												<td><input type="date" style="height: 20px; width: 90px;font-size: 5px;" name="checkdata[]" value="<?php echo $checkdata[5];?>" /></td>
		        ...
		        <div class="tab-pane" id="about-2">
                  <section id="unseen">
			            <!-- button list -->
				          	<div>
				            <button class="btn btn-success" type="button" onclick="Openwindown_refresh('ware/imitation_1/new_case/new case 00.php')" >新建</button><!--ware/imitation_1/new_case/new case 00.php-->
...
//									}
           	...
           	<div class="tab-pane" id="about-3">
                  <section id="unseen">
                  	<div>
		              	<button class="btn btn-success" type="button" onclick="Openwindown_refresh('ware/imitation_1/new_fs/new_case.php')">新建</button><!--ware/imitation_1/new_case/new case 00.php-->
...
//							}
           ...
           <div class="tab-pane" id="about-4">
              <section id="unseen">
              	<div>
	              	<button class="btn btn-success" type="button" onclick="Openwindown_refresh('ware/imitation_1/new_yearcost/new case 01.php')">新建</button><!--ware/imitation_1/new_case/new case 00.php-->
...
//              		require'conn.php';
    ...
    <div class="modal fade" id="addModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<!--结案模块 end-->
    <!--修改案源人代理人 Begin-->
    <div class="modal fade" id="addModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">批量修改案源人 & 代理人</h4>
                </div>
                <div class="modal-body">
                    <div action="#" class="form-horizontal " id="my_form">
                        <!--<div class="form-group">
                            <label class="control-label col-md-4">批量修改案源人</label>
                            <div class="col-md-6 col-xs-11">
                                <input id="reason_fs" class="form-control form-control-inline input-medium" type="text" />
                            </div>
                        </div>
                        <div action="#" class="form-horizontal " id="my_form">
                            <label class="control-label col-md-4">批量修改代理人</label>
                            <div class="col-md-6 col-xs-11">
                                <input id="reason_fs" class="form-control form-control-inline input-medium" type="text" />
                            </div>
                        </div>-->
                        <div class="form-group">
                            <strong><span class="col-lg-8">对被选中案件的操作</span></strong>
                            <br />
                            <div class="form-group">
                                <label class="control-label col-md-4">批量修改案源人</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="caseAyr_1" class="form-control form-control-inline input-medium" type="text" onclick="select_ayr(this.id)" readonly="readonly"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">批量修改代理人</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="caseDlr_1" class="form-control form-control-inline input-medium" type="text" onclick="select_dlr(this.id)" readonly="readonly"/>
                                </div>
                            </div>
                            <hr />
                            <strong><span class="col-lg-8">操作全部案件的案源人代理人</span></strong>
                            <br />
                            <div class="form-group">
                                <label class="control-label col-md-4">原案源人</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="caseAyr_2" class="form-control form-control-inline input-medium" type="text" onclick="select_ayr(this.id)"  readonly="readonly"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">新案源人</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="caseAyr_3" class="form-control form-control-inline input-medium" type="text" onclick="select_ayr(this.id)"  readonly="readonly"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">原代理人</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="caseDlr_2" class="form-control form-control-inline input-medium" type="text" onclick="select_dlr(this.id)"  readonly="readonly"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">新代理人</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="caseDlr_3" class="form-control form-control-inline input-medium" type="text" onclick="select_dlr(this.id)"  readonly="readonly"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer" align="center">
                        <button id="" class="btn btn-primary" type="button" onclick="clearAll()">清空</button>
                        <button id="" class="btn btn-primary" type="button" onclick="changeCaseMan('dynamic-table_2')">替换</button>
                        <button data-dismiss="modal" class="btn btn-primary" type="button">关闭</button>
                    </div>
                </div>
            </div>
    ...
    $('#dynamic-table').dataTable( {
        ...
        "sAjaxSource": "index_jsondata.php",
	        ...
	        "fnServerParams": function ( aoData ) {
		        aoData.push({ "name": "my_flag", "value": "申请案件" });
		    	},
					"sAjaxDataProp": "data",
					"aoColumns":[
...
if($("#ischecked").attr("value") == "没有查询信息"){
    ...
    $('#dynamic-table_4').dataTable( {
        ...
        "sAjaxSource": "index_jsondata.php",
	        "sServerMethod": "GET",
	        "fnServerParams": function ( aoData ) {
		        aoData.push({ "name": "my_flag", "value": "年费案件" });
		    	},
					"sAjaxDataProp": "data",
					"aoColumns":[
						{"mData":"inputcheckbox","sClass":"center"},
    ...
    $('#dynamic-table_5').dataTable( {
        ...
        "sAjaxSource": "index_jsondata.php",
	        "sServerMethod": "GET",
	        "fnServerParams": function ( aoData ) {
		        aoData.push({ "name": "my_flag", "value": "失败案件" });
		    	},
					"sAjaxDataProp": "data",
					"aoColumns":[
						{"mData":"inputcheckbox","sClass":"center"},
...
//打开新的页面，关闭后刷新父页面
function Openwindown_refresh(newurl){
	var winobj = window.open(newurl,"_blank");
