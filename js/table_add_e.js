	...
	function addRow(){
		...
		newRow.insertCell(1).innerHTML = "<input type='text' id='ajh["+onclick_cs+"]'  value='' name='"+onclick_cs+"' readonly />";//ajh
		newRow.insertCell(2).innerHTML = '<select name="lx" id="lx['+onclick_cs+']" onchange="changeAJH(this)"><option value="发明专利">发明专利</option><option value="实用新型">实用新型</option><option value="外观设计">外观设计</option></select>';//type
