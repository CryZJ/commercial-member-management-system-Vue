...
$objPHPExcel->getActiveSheet()->setCellValue('C1','软件名称');
...
//$sql_s = "SELECT 案卷号,软件名称,申请人id,申请号,申请日期,案源人,代理人,案件备注 FROM 软件_信息 WHERE 状态<>3";
$sql_s = "SELECT 案卷号,软件名称,申请人id,申请号,申请日期,案源人,代理人,案件备注 FROM 软件_信息 WHERE FIND_IN_SET(案卷号,'".$str_ajh."') AND 状态<>3 AND 状态<>9";
...
if($result->num_rows>0){
	while($row = $result->fetch_assoc()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C'.$i,$row['软件名称']);
