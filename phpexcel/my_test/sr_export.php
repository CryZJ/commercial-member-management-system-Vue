...
//$sql_s = "SELECT id,客户名称,项目内容,总收费,规费,管理费,税费,收费方式,收费日期,案源人  FROM 收入记录 WHERE  FIND_IN_SET(id,'".$str_id."') ORDER BY 收费日期 ";	
$sql_s = "SELECT id,客户名称,项目内容,总收费,规费,管理费,税费,收费方式,收费日期,案源人  FROM ".$earn_record." WHERE  FIND_IN_SET(id,'".$str_id."') ORDER BY 收费日期 ";	
