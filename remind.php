<?php
	require 'AHeader.php';
//	require_once 'update_remind_day.php';弃用
?>
		...
		<section class="panel">
			<header class="panel-heading custom-tab">
              	<span class="tools pull-right">
		            <a class="fa fa-reply" href="javascript:history.go(-1)">返回</a>
		      	</span>
              <ul class="nav nav-tabs">
              	<li class="about-1 active"><a href="#about-1" data-toggle="tab"><i class="fa fa-clock-o"></i>事件监控</a></li>
