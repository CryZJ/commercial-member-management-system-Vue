...
<section>
	...
	<section class="panel">
			...
			<input type="text" style="background-color:transparent;border: none;" id="ajdlr" value="<?php echo $ajdlr; ?>" readonly=="readonly" hidden="hidden" />
	           ...
	           <div class="panel-body" style="width:98%; overflow:auto; solid #000000;">
	           	<label>案件处理人：</label><input type="text" style="background-color:transparent;border: none;" id="ajdlr" value="<?php echo $name; ?>"  readonly />
	           	 <label>案件类型：</label><input type="text" id="ctypem" value="" />
	           	<!--<label hidden="hidden">委托书类型：</label><strong id="ajlx"></strong>
	           	...
	           	<label>原案卷号：</label> <input type="text" id="rajh"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	           	<label>专用权始：</label><input type="date" style="height: 26px;" id="zyqs" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	           	<label>专用权末：</label><input type="date" style="height: 26px;" id="zyqm" />
	           	<input type="text" id="RePC" hidden="hidden" />
	                ...
	                <table class="table table-striped  table-bordered" id="tabUserInfo_1">
		                ...
		                <tbody >
		                	<tr>
								...
								<td id="thna" style="width: 200px;" hidden="hidden"></td>
								<td><input style="width: 400px;" type="text" id="thbz" /></td>
							</tr>
							<tr>
		                		<th rowspan="6" id="SeName">商品/服务<input class="btn btn-primary" style="width: 60px;" type="button" value="+" onclick="addSevM_Mag()" />
	                			<td colspan="3" >1.<input style="width:90%;" name="SerN" /></td><td colspan="2" >2.<input style="width:90%;" name="SerN" /></td></th>
		                	</tr>
		                	<tr><td colspan="3" >3.<input style="width:90%;" name="SerN" /></td><td colspan="2" >4.<input style="width:90%;" name="SerN" /></td></tr>
		                	<tr><td colspan="3" >5.<input style="width:90%;" name="SerN" /></td><td colspan="2" >6.<input style="width:90%;" name="SerN" /></td></tr>
		                	<tr><td colspan="3" >7.<input style="width:90%;" name="SerN" /></td><td colspan="2" >8.<input style="width:90%;" name="SerN" /></td></tr>
		                	<tr><td colspan="3" >9.<input style="width:90%;" name="SerN" /></td><td colspan="2" >10.<input style="width:90%;" name="SerN" /></td></tr>
		                </tbody>
	                </table>
	                
	                <input class="btn btn-primary" type="button" value="选择申请人" onclick="select_sqr()" />
	                ...
	                <table class="table table-striped  table-bordered" id="">
				       		...
				       		<tr>
								...
								<td colspan="5" ><input style="width:95%;" placeholder="请选择正确的地址......" type="text" id="addc" list="add_other" /><datalist id="add_other"></datalist></td>
				       		</tr>
				       		<tr>
	                ...
	                <table class="table table-striped  table-bordered" id="">
	                <input class="btn btn-primary" type="button" id="zjsqr" value="增加申请人" onclick="select_zjsqr()"/>
	                <input type="text" id="sqrid1" hidden="hidden" />		               	
				       		...
				       		<tr>
				       			<th colspan="1" >地址(中文)</th>
								<td colspan="5" ><input style="width:95%;" placeholder="请选择正确的地址......" type="text" id="addc1" list="add_other" /><datalist id="add_other"></datalist></td>
				       		</tr>
				       		<tr>
				       			<th colspan="1" >地址(英文)</th>
	    ...
	    <div align="center" ><input class="btn btn-primary" type="button" value="提交信息" onclick="savemes_CaseMes(this)" />&nbsp;&nbsp;&nbsp;<input class="btn btn-warning" type="button" value="返回" id="PageBack" /></div><br />
