                  ...
                  <span class="dynamic-table" hidden="hidden" >1/asc/案卷号【正】</span>
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table" >
		            	...
		            	<?php
									  require("../../../conn.php");
									  if($admin == "1"){
									  	$sql="select a.案件类型,a.`案卷号`,a.`案源人`,a.`代理人`,a.`委托人类型`,a.`申请人id`,a.`商标说明`,a.状态,a.案件状态,a.类别  from 商标_案件 a,商标_委托书 b  where a.状态<>'3' and a.委托书id=b.id and 注册号 IS NULL and a.状态<>'9' order by a.id desc";
									  }else{
									  	$sql="select a.案件类型,a.`案卷号`,a.`案源人`,a.`代理人`,a.`委托人类型`,a.`申请人id`,a.`商标说明`,a.状态,a.案件状态,a.类别  from 商标_案件 a,商标_委托书 b  where a.状态<>'3' and a.状态<>'2' and a.委托书id=b.id and 注册号 IS NULL and a.状态<>'9' order by a.id desc ";
									  }
            	...
            	<div class="tab-pane" id="about-3">
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table_3" >
		            	...
		            	<?php
						  ...
						  $ajh_str = "";
						  $now_date = date("Y-m-d");
						  $sql_jk = "SELECT 案卷号 FROM 商标_监控 WHERE 监控名='专用权期监控'AND 提醒日期<'".$now_date."' AND 状态=0";
						  ...
						  $ajh_str = substr($ajh_str, 1);
						  if($admin == "1"){
						  	$sql="select a.案件类型,a.注册日,a.注册号,a.`案卷号`,a.`案源人`,a.`代理人`,a.`委托人类型`,a.`申请人id`,a.`商标说明`,a.状态,a.案件状态  from 商标_案件 a,商标_委托书 b  where FIND_IN_SET(案卷号,'".$ajh_str."') AND a.状态<>'3' and a.委托书id=b.id and 注册号 IS NULL and a.状态<>'9'";
						  }else{
						  	$sql="select a.案件类型,a.注册日,a.注册号,a.`案卷号`,a.`案源人`,a.`代理人`,a.`委托人类型`,a.`申请人id`,a.`商标说明`,a.状态,a.案件状态  from 商标_案件 a,商标_委托书 b  where FIND_IN_SET(案卷号,'".$ajh_str."') AND a.状态<>'3' and a.状态<>'2' and a.委托书id=b.id and 注册号 IS NULL and a.状态<>'9'";
						  }
						  $result = $conn->query($sql);
						  if($result->num_rows >=0){
						  	while($row = $result->fetch_assoc()){
                  ...
                  <section id="unseen">
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table_4" >
		            	...
		            	<?php
						  require("../../../conn.php");
						  if($admin == "1"){
						  	$sql="select a.案件类型,a.注册日,a.注册号,a.`案卷号`,a.`案源人`,a.`代理人`,a.`委托人类型`,a.`申请人id`,a.`商标说明`,a.状态,a.案件状态,a.类别   from 商标_案件 a where a.状态<>'3'  and a.状态<>'9' order by a.id desc";
						  }else{
						  	$sql="select a.案件类型,a.注册日,a.注册号,a.`案卷号`,a.`案源人`,a.`代理人`,a.`委托人类型`,a.`申请人id`,a.`商标说明`,a.状态,a.案件状态,a.类别  from 商标_案件 a  where a.状态<>'3' and a.状态<>'2'  and a.状态<>'9' order by a.id desc";
						  }
						  $result = $conn->query($sql);
						  if($result->num_rows >0){
						  	while($row = $result->fetch_assoc()){
