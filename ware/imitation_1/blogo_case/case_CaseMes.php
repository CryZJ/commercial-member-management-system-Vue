	        ...
	        <div class="tab-pane active" id="about-1">
	    		  <section id="unseen">
	    		  	<?php
	        			...
	        			//获取案卷基本情况
	        			require('../../../conn.php');
	        			$sql = "select 原案卷号,案件类型,id,委托人类型,案源人,代理人,注册日,注册号,委托书id,专权期始,专权期末,备注,申请人,申请人id,申请人商标地址,状态,类别,商标说明,商品服务  from 商标_案件 a  where a.案卷号='".$ajh."'";
		        	...
		        	<?php 
                    	...
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<strong>原案卷号:<?php echo $AOVI; ?></strong> 
...
//				        					 echo $cMKN;
		                	...
		                	<tr>
		                		<th>案卷号</th>
								<td><p id="ajh1"><?php echo $ajh; ?></p></td>
				        		<th>案源人</th>
...
<!--	                <input class="btn btn-primary" type="button" onclick="client_new();getajh()" value="增加申请人" />-->
	                <!--//删除申请人-->
	                <!--<strong>删除：</strong>
	                <select class="btn btn-primary dropdown-toggle checilck" id="scid">
	                	<?php
	                		$arrsqrid=explode("、",$sqrid);
	                		for($i=1;$i<count($arrsqrid);$i++){
                				$sql4 = "select * from 申请人 where id = '".$arrsqrid[$i]."'";
                				$result4 = $conn->query($sql4);
                				$row4 = $result4->fetch_assoc();
                		?>
	                	<option value="<?php echo $arrsqrid[$i]; ?>"><?php echo $row4['申请人']; ?></option>
	                	<?php } ?>
	                </select>
	                <input type="button"value="删除" class="btn btn-primary"id="shanchu"/>
	                <input id="ysqrid" type="hidden" value="<?php echo $sqrid; ?>" />
	                <input id="ysqrname" type="hidden" value="<?php echo $sqrname; ?>" />-->
	                <!--//删除申请人-->	                
...
//		var myselect = document.getElementById("scid");
//		var index = myselect.selectedIndex ;
//		var scrid = myselect.options[index].value;
//		var scrname = myselect.options[index].text;
//		var ysrid = document.getElementById("ysqrid");
//		var ysqrid = ysrid.value;
//		var anjh = document.getElementById("ajh");
//		var ajh = anjh.value;
//		var sqrxm = document.getElementById("ysqrname");
//		var ysqrname = sqrxm.value;
//		alert(ysqrid);
//	    $.ajax({
//			url:"case_del.php",
//			type:"POST",
