...
//				        					 echo $cMKN;
	                ...
	                <table class="table table-striped table-bordered text-center" id="tabUserInfo_2">
	                	<tr>
	                		<th>委托书</th>
							<td><span id="mes">
		                			<?php
					...
					?>
						<tr>
							...
							<td>
								...
								<?php if($CaseST ==0){?>
										<button name="<?php echo $row5["案卷号"]; ?>" id="<?php echo $row5['id']; ?>" class="btn btn-danger" onclick="change_sb(this)">替换</button>
						        <?php } ?>
