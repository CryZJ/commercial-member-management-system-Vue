...
//	                		echo $Csqrc.','.$Csqre.','.$Caddc.','.$Cadde.','.$Cidn.','.$Cenum.','.$Ccode.','.$Ccoty;
	                ...
	                <table class="table table-striped  table-bordered" id="tabUserInfo_2">
	                	<?php
	                		$sqlZ = "SELECT 变更前名义C,变更前名义E,变更前地址C,变更前地址E,变更管理规则,变更集体成员名单,共有商标是  FROM 商标_案件附加信息  WHERE 案卷号='".$ajh."'";
...
//							if($CBOR){$CBOR='是';}else{$CBOR='否';}
//							if($CTML){$CTML='是';}else{$CTML='否';}
//							if($AOVI){$AOVI='是';}else{$AOVI='否';}
	                	?>
				       		<tr>
				        		<th>变更前名义(中文)</th>
				        		<td colspan="2"><input type="text" class="Change" style="width: 90%;" value="<?php echo $CBNC; ?>" onchange="changeMes2('BGQMYC',this)" /></td>
								<th>变更前名义(英文)</th>
				        		<td colspan="2"><input type="text" class="Change" style="width: 90%;" value="<?php echo $CBNE; ?>" onchange="changeMes2('BGQMYE',this)" /></td>
				       		</tr>
				       		<tr>
				        		<th>变更前地址(中文)</th>
				        		<td colspan="2"><input type="text" class="Change" style="width: 90%;" value="<?php echo $CBAC; ?>" onchange="changeMes2('BGQDZC',this)" /></td>
								<th>变更前地址(英文)</th>
				        		<td colspan="2"><input type="text" class="Change" style="width: 90%;" value="<?php echo $CBAE; ?>" onchange="changeMes2('BGQDZE',this)" /></td>
				       		</tr>
				       		<tr>
				       			<th>变更管理规则</th>
								<td>
									<select onchange="changeMes2('BGGLGZ',this)">
									<?php
										if($CBOR){
									?>
				        		...
				        		<th>变更集体成员名单</th>
				        		<td>
				        			<select onchange="changeMes2('CYMD',this)">
									<?php
										if($CTML){
									?>
									<option value="1">是</option>
