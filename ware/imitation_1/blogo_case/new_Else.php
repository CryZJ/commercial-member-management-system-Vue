...
<section>
	...
	<section class="panel">
			...
			<input type="text" style="background-color:transparent;border: none;" id="ajdlr" value="<?php echo $ajdlr; ?>" readonly=="readonly" hidden="hidden" />
	           ...
	           <div class="panel-body" style="width:98%; overflow:auto; solid #000000;">
	           	...
	           	<input type="text" id="RePC" hidden="hidden" />
	                ...
	                <!--<input class="btn btn-primary" type="button" value="选择申请人" onclick="select_sqr()" /><br /><br />-->
	                ...
	                <table class="table table-striped  table-bordered" id="file_list">
	                	...
	                	<tr>
	                		<th>其他文件</th>
											<th colspan="3" ><input id="other_file" type="file" name="myfile[]" multiple="multiple" /></th>
	                	</tr>-->
	                	<tr>
	                		<th>其他文件</th>
	    ...
	    <div align="center" ><input class="btn btn-primary" type="button" value="提交信息" onclick="savemes_other(this)" />&nbsp;&nbsp;&nbsp;<input class="btn btn-warning" type="button" value="返回" id="PageBack" /></div><br />
