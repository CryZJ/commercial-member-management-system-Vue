...
<section>
	...
	<section class="panel">
		<header class="panel-heading">
			...
			<strong>商标转让</strong>
	           ...
	           <div class="panel-body" style="width:98%; overflow:auto; solid #000000;">
	           	...
	           	<label>转让人委托书类型：</label><strong id="ajlx"></strong><input style="background-color:transparent;border: none;"readonly="readonly" />
	           	<label>受让人委托书类型：</label><strong id="ajlx2"></strong><br />
	           	<input class="btn btn-primary" type="button" value="转让人委托书" onclick="openW()" id="ReP" />
	           	...
	           	<input type="text" id="RePC2" hidden="hidden" />
	                <br />
	                <br />
	                <table class="table table-striped  table-bordered" id="tabUserInfo_1">
		                <thead>
			                <tr>
						        		<th hidden="hidden">转让人类型</th>
						        		<th hidden="hidden">受让人类型</th>
						        		<th>案源人</th>
						        		<th>代理人</th>
						        		<th>案卷号</th>
						        		<th>类别</th>
		                	...
		                	<tr>
						        		...
						        		<td><input type="text" id="ajh" name="ajh" value="<?php echo $ajh; ?>" readonly="readonly" /></td>
							       		<td><input style="width: 50px;" type="text" value="<?php echo $ttype; ?>" id="CType" onclick="SetType()" readonly="readonly" />
												...
												<td><input style="width: 300px;" type="text" id="thbz" /></td>
											</tr>
		                </tbody>
	                </table>
	                ...
	                <table class="table table-striped  table-bordered" id="">
					       		<tr>
					        		...
					        		<td colspan="2"><input style="width: 400px;" type="text" readonly="readonly" id="sqrc"/></td>
											<th>转让人(英文名)</th>
					        		<td colspan="2"><input style="width: 400px;" type="text" readonly="readonly" id="sqre" /></td>
					        	</tr>
					       		<tr>	
					       			<th>证件文件编号</th>
											<td><input style="width: 250px;" type="text" readonly="readonly" id="sfzh" /></td>
					       			<th>邮编</th>
											<td><input style="width: 250px;" type="text" readonly="readonly" id="stmp" /></td>
											<th>国籍</th>
											<td><input style="width: 250px;" type="text"  readonly="readonly" id="coty" /></td>
					       		</tr>
					       		<tr>
					       			<th colspan="1" >地址(中文)</th>
											<td colspan="5" ><input style="width:95%;" type="text" readonly="readonly" id="addc" /></td>
					       		</tr>
					       		<tr>
					       			<th colspan="1" >地址(英文)</th>
											<td colspan="5" ><input style="width:95%;" type="text" readonly="readonly" id="adde" /></td>
					       		</tr>
	                </table>
	                <input class="btn btn-primary" type="button" value="受让人委托书" onclick="openW2()" id="ReP2" />
	                <br /><br />
	                <input type="text" id="sqrid2" hidden="hidden" />
	                <table class="table table-striped  table-bordered" id="">
					       		<tr>
					        		<th>受让人(中文名)</th>
					        		<td colspan="2"><input style="width: 400px;" type="text" readonly="readonly" id="sqrc2"/></td>
											<th>受让人(英文名)</th>
					        		<td colspan="2"><input style="width: 400px;" type="text" readonly="readonly" id="sqre2" /></td>
					        	</tr>
					       		<tr>	
					       			<th>证件文件编号</th>
											<td><input style="width: 250px;" type="text" readonly="readonly" id="sfzh2" /></td>
					       			<th>邮编</th>
											<td><input style="width: 250px;" type="text" id="stmp2" readonly="readonly" /></td>
											<th>国籍</th>
											<td><input style="width: 250px;" type="text" id="coty2"  readonly="readonly" /></td>
					       		</tr>
					       		<tr>
					       			<th colspan="1" >地址(中文)</th>
											<td colspan="5" ><input style="width:95%;" type="text" id="addc2" readonly="readonly" /></td>
					       		</tr>
					       		<tr>
					       			<th colspan="1" >地址(英文)</th>
											<td colspan="5" ><input style="width:95%;" type="text" id="adde2" readonly="readonly" /></td>
					       		</tr>
	                </table>
	                <table class="table table-striped  table-bordered" id="other_info">
	                	<tr>
	                		<th>外国受让人的国内接收人</th>
	                		<th>邮政编码</th>
	                		<th>国内接收人地址</th>
	                ...
	                <!--<button class="btn btn-primary">文件上传</button>文件的上传做成申请人那种，文件加备注，下载的时候所文件和委托书打包下载-->
	                <div>
	    ...
	    <div align="center" ><input class="btn btn-primary" type="button" value="提交信息" onclick="savemes_transfer(this)" />&nbsp;&nbsp;&nbsp;<input class="btn btn-warning" type="button" value="返回" id="PageBack" /></div><br />
...
<!--转让独有-->
<script src="../../../js/imitation_1/BLogo_B.js"></script>
<!--图片显示-->
