...
<section>
	...
	<section class="panel">
		<header class="panel-heading">
			...
			<input type="text" style="background-color:transparent;border: none;" id="ajdlr" value="<?php echo $ajdlr; ?>" readonly="readonly" hidden="hidden" />
	           ...
	           <div class="panel-body" style="width:98%; overflow:auto; solid #000000;">
	           	...
	           	<label>是否共有商标：</label><input type="checkbox" id="judge_tyhb_1" />是 &nbsp;&nbsp;&nbsp;<input type="checkbox" id="judge_tyhb_0" />否
	    ...
	    <div align="center" ><input class="btn btn-primary" type="button" value="提交信息" onclick="savemes_chang(this)" />&nbsp;&nbsp;&nbsp;<input class="btn btn-warning" type="button" value="返回" id="PageBack" /></div><br />
