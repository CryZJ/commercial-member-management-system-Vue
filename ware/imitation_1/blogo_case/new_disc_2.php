...
<section>
	...
	<section class="panel">
        ...
        <div class="panel-body" style="width:98%; overflow:auto; solid #000000;">
            ...
            <table id="info_0">
            	<tr>
            		<td><label>委托人：</label><input class="diffinput input_long"  type="text" readonly="readonly"/></td>
            		<td><label>地址：</label><input class="input_long" type="text" placeholder="选填正确的地址" list="addreslist_wtr"/><datalist id="addreslist_wtr"></datalist></td>
            	</tr>
            	
            	<tr>
            		<td><label>法定代表人/负责人姓名：</label><input type="text" placeholder="需手动填写" /></td>
            		<td><label>职务：</label><input type="text" placeholder="需手动填写" /></td>
            	</tr>
            	
            	<tr>
            		<td><label>受托人：</label><input class="diffinput input_long" type="text" readonly="readonly"/></td>
            		<td><label>地址：</label><input class="input_long" type="text" placeholder="选填正确的地址" list="addreslist_str"/><datalist id="addreslist_str"></datalist></td>
            	</tr>
            	
            	<tr>
            		<td><label>联系人：</label><input class="diffinput" type="text" readonly="readonly" /></td>
            		<td><label>电话：</label><input class="diffinput" type="text" readonly="readonly" /></td>
            	</tr>
            </table>
            ...
            <table id="info_1">	
            	<tr>
            		<td colspan="2">
            			<blockquote>
            				委托人是<input class="diffinput input_min" type="text" readonly="readonly" />国家/地区的公民/法人，现委托人代理对第<input class="input_min" type="text" placeholder="需手动填写" />类第<input type="text" placeholder="需手动填写" />号<input type="text" placeholder="需手动填写" />商标进行如下" &radic; "评审事宜：
            			</blockquote>
            	...
            	<tr>
            		<td colspan="2" id="select_pssy">
            			<input type="checkbox" id="pssy_0" /><label for="pssy_0">驳回商标注册申请复审案</label> &nbsp;&nbsp;&nbsp;&nbsp; 
            			<input type="checkbox" id="pssy_1" /><label for="pssy_1">商标不予注册复审案</label> &nbsp;&nbsp;&nbsp;&nbsp;
            			<input type="checkbox" id="pssy_2" /><label for="pssy_2">撤销注册商标复审案</label> &nbsp;&nbsp;&nbsp;&nbsp;
            			<input type="checkbox" id="pssy_3" /><label for="pssy_3">注册商标无效宣告案</label> &nbsp;&nbsp;&nbsp;&nbsp;
            			<input type="checkbox" id="pssy_4" /><label for="pssy_4">注册商标无效宣告复审案</label>
            		</td>
            	</tr>
            	<tr>
            		<td colspan="2">
            	...
            	<tr>
            		<td colspan="2" id="select_qx">
            			<input type="checkbox" id="qx_0" /><label for="qx_0">①承认对方评审请求</label>&nbsp;&nbsp;&nbsp;&nbsp;
            			<input type="checkbox" id="qx_1" /><label for="qx_1">②放弃或者变更评审请求</label>&nbsp;&nbsp;&nbsp;&nbsp;
            			<input type="checkbox" id="qx_2" /><label for="qx_2">③撤回商标评审申请</label>
            		</td>
            	</tr>
            	<tr>
            		<td colspan="2">
            			<label>日期：</label><input type="date" id="date_info" style="height: 20px;" />
            		</td>
            	</tr>
            </table>
            <br /><br /><br />
