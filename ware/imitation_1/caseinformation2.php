    ...
    <section class="panel">
      <header class="panel-heading custom-tab">
	      ...
	      <ul class="nav nav-tabs">
	        <li class="about-1"><a href="#about-1" data-toggle="tab"> 案卷基本情况 </a></li>
	        <li class="about-2"><a href="#about-2" data-toggle="tab"> 案卷流程及文档 </a></li>
	        <li class="about-3 active"><a href="#about-3" data-toggle="tab"> 费用明细 </a></li>
            ...
            <table class="table table-bordered table-striped table-condensed" >
                ...
                <tr>
	                ...
	                <td class="numeric">
                		...
                		<!--<input style="height: 26px;" name="change" type="date" value="<?php echo $zlxx[6];//date("Y-m-d", strtotime($zlxx[6]));  ?>" />-->
	                </td>
...
//										}
            ...
            <table class="table table-bordered table-striped table-condensed" id="jftable">
                ...
                ?>
        			<tr>
        				...
        				<?php if($CaseST == 0){ ?>
        				<th>
        					<input class="btn btn-primary" type="button" id="btn<?php echo $num; ?>" onclick="ChangeFare('<?php echo $num; ?>',this.value,'<?php echo $ajh; ?>')" value="修改" />&nbsp;&nbsp;&nbsp;
        					<input class="btn btn-danger" type="button" id="delF<?php echo $num; ?>" onclick="FareDel(this)" value="删除" />
        				</th><?php } ?>
            ...
            <table class="table table-bordered table-striped table-condensed" id="jftable">
                ...
                <?php
                	require('../../conn.php');
//              	$sql4 = "select a.案卷号,a.费用名称,a.金额,a.提醒时间,a.缴费期限,a.状态  from 专案需交费用   a,专案_年费记录   b  where a.案卷号 = '".$ajh."' and a.案卷号 =b.案卷号 and a.状态 = '0'";
                	$sql4 = "CALL p0('".$ajh."');";
//              	$sql4 = "SELECT id,案卷号,费用名称,金额,提醒时间,缴费期限 FROM ((SELECT id,案卷号,费用名称,金额,提醒时间,缴费期限 FROM 专案需交费用 WHERE 案卷号 = '".$ajh."' AND 状态='0' ) UNION (SELECT id,案卷号,年度 AS 费用名称,金额,提醒日期 AS 提醒时间 ,应缴日期 AS 缴费期限 FROM 专案_年费记录 WHERE 案卷号 = '".$ajh."' AND 状态='0' )) AS C";
//              	$sql4="CALL p12('".$ajh."')";
                	$result4 = $conn->query($sql4);
                	$num=1;
                	if($result4->num_rows > 0){
