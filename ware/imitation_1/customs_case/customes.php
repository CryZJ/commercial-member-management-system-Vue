        		...
        		<section class="panel">
        			<header class="panel-heading custom-tab">
		              <ul class="nav nav-tabs">
		                <li class="active"><a href="#about-1" data-toggle="tab"><i class="fa fa-user"></i>海关备案</a></li>
           			...
           			<div class="panel-body">
			        	<div class="tab-content">                             
					        <div class="tab-pane active" id="about-1">
			                  <section id="unseen">
					          	<div>
					        <a href="new_case.php" target="_blank"><button class="btn btn-success" type="button">新建</button></a>
								    ...
								    ?>
								    	<a href="../../../phpexcel/my_test/hg_export.php" target="_blank"><button class="btn btn-primary" type="button">导出Excel清单</button></a>
	            				<button class="btn btn-primary" onclick="Export_someExcel('dynamic-table','../../../phpexcel/my_test/hg_export_some.php')">导出选中行Excel清单</button>
					            <!-- button list end -->
					            <!-- /btn-group -->
				            	<div class="btn-group" style="float: right;" >
                                    <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button" name="MenuCM">
                                    	<?php 
                                    		require'../../../conn.php';
                                    		//查询
                                    		$sqlO1 = "select 海 from 表格顺序 where 用户id = '".$userid."'";
                                    ...
                                    <ul role="menu" class="dropdown-menu checilck" id="MenuCM" ><!--OrderZL()--> 
                                        ...
                                        <li><a href="#">申请号</a></li>
                                        <li><a href="#">备案监控</a></li>
                                        <li><a href="#">备案时间【正】</a></li>
                                        <li><a href="#">备案时间【倒】</a></li>
                                        <li><a href="#">状态</a></li>
                                    </ul>
                                </div>
                            <!-- /btn-group -->
			                    ...
			                    <table class="display table table-bordered table-striped" id="dynamic-table" >
					                  <thead>
					                    <tr>
						                    ...
						                    <th class="numeric">案件名称</th>
						                    <th class="numeric">申请人</th>
						                    <th class="numeric" style="width: 100px;">申请号</th>
						                    <th class="numeric" style="width: 100px;">备案监控</th>
						                    <th class="numeric" style="width: 100px;">备案时间</th>
						                    <th class="numeric" style="width: 100px;">状态</th>
						                    <th class="numeric" style="width: 100px;">备案号</th>
						                  </tr>
					                  </thead>
					                   <tbody>
					                   	<?php
					                   		...
					                   		if($dlrbh != null && $ayrbh != null){
					                   			if($admin == 1){
					                   				$sql="select *  from 海关_案件  where 状态<>'3' and 状态<>9 ";
					                   			}else{
					                   				$sql="select *  from 海关_案件  where 状态<>'3' and 状态 <>'2' and 状态<>9 ";
					                   			}
...
//					                   				
					                   				?>
					                   				<tr>
					                   					<th><input class="box_son" type="checkbox" value="<?php echo $num; ?>" id="<?php echo $row["案卷号"];?>" /></th>
						                					<td class="numeric"><a href="case_mess.php?ajh=<?php echo $row['案卷号']; ?>" target="_blank" ><?php echo $row['案卷号']; ?></a></td>
						                					<!--<td class="numeric"><?php echo $row['案卷号']; ?></td>-->
						                					<td class="numeric"><?php echo $row['名称']; ?></td>
						                					<td class="numeric"><?php echo $row['申请人']; ?></td>
						                					<td class="numeric"><?php echo $row['申请号']; ?></td>
						                					<td class="numeric"><?php echo $row['备案监控']; ?></td>
						                					<td class="numeric"><?php echo $row['备案日期']; ?></td>
					                					<?php
			                        						if($row["状态"]==0){
			                        					?>
			                        						<td class="numeric">申请中</td>
			                        					<?php
			                        						}  
			                        					?>
			                        					<?php
			                        					...
			                        					?>
			                        			<td class="numeric"><?php echo $row['备案号']; ?></td>
				                					</tr>
					                   				<?php
					                   					$num++;
					                   			}
