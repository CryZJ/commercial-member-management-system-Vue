	    ...
	    <div class="panel-body" style="width: 98%;overflow: auto;solid #000000">
				...
				<table class="table table-bordered table-striped table-condensed" id="tab_sqr">
	                ...
	                <tr align="center">
	                	...
	                	<td><input type="text" name="ajh" id="ajh" value=""  readonly="readonly"/></td>
	                	<td><input style="width: 300px;" type="text" id="rjmc"</td>
	                </tr>
	            </table>
				...
				<!--进度条 end-->
	            <p><input id="up_file" type="file"  multiple="multiple"></p>
	            <div>
					<table>
						<thead>
							<th>文件列表</th>
	            ...
	            <!--图片显示-->
	            <!--<img style="width:33%;height:300px;" id="rjyl" src="" />-->
	            </div>
	            	<!--<div align="center"><input type="submit" style="width: 80px;" onclick="save_data_rj()"></div>-->
	            	<div align="center">
	            		<button class="btn btn-primary" type="button" onclick="save_data_rj(this)">提交信息</button>
...
<!--选择案源人，代理人,生成案卷号-->
<script src="../../../js/slectsqrrj.js"></script>
<!--图片选择显示-->
