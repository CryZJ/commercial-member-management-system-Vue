                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <?php
		                        	...
		                        	$time 		= date("Y-m-d");
															...
															$i=0;
															while($i<$len){
															$sql = "select * from 软件_信息 where 案卷号 = '".$ajh_zz[$i]."'";
//															echo $sql;
...
//							  		     					echo print_r($sqrlen);
													for($j=0;$j<$len1;$j++){
											  		     	$sql1 = "select 申请人 from 申请人 where id='".$sqrlen[$j]."'";
                    ...
                    <div align="center"><button class="btn btn-primary" id="sure" onclick="jasave()">提交</button></div>
