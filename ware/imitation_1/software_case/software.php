        	...
        	<div class="col-sm-12">
        		<section class="panel">
        			<header class="panel-heading custom-tab">
		              <ul class="nav nav-tabs">
		                <li class="active"><a href="#about-1" data-toggle="tab"><i class="fa fa-user"></i>软件查询</a></li>
           	...
           	<div class="panel-body">
                  ...
                  <section id="unseen">
			            ...
			            <!-- button list -->
				          	<div>
				              <!--<a href="case_rj.php" target="_blank"><button class="btn btn-success" type="button" onclick="Open_add()">新建</button></a>-->
...
//									}
								...
								?>
										<a href="../../../phpexcel/my_test/rj_export.php" target="_blank"><button class="btn btn-primary" type="button">导出Excel清单</button></a>
	            			<button class="btn btn-primary" onclick="Export_someExcel('dynamic-table','../../../phpexcel/my_test/rj_export_some.php')">导出选中行Excel清单</button>
				            <!-- button list end -->
				            <!-- /btn-group -->
				            	<div class="btn-group" style="float: right;" >
                                    <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button" name="MenuSW">
                                    	<?php 
                                    		require'../../../conn.php';
                                    		//查询
                                    		$sqlO1 = "select 软 from 表格顺序 where 用户id = '".$userid."'";
                                    ...
                                    <ul role="menu" class="dropdown-menu checilck" id="MenuSW" ><!--OrderZL()--> 
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table" >
						  ...
						  if($dlrbh != null && $ayrbh != null){
						  	if($admin == 1){
						  		$sql="select 案卷号,软件名称,申请人id,申请人,案源人,代理人,申请号,申请日期,状态,案件状态,登记号  from 软件_信息  where 状态<>'3' and 状态 <>9 order by id desc";
						  	}else{
						  		$sql="select 案卷号,软件名称,申请人id,申请人,案源人,代理人,申请号,申请日期,状态,案件状态 ,登记号 from 软件_信息  where 状态<>'3' and 状态<>'2' and 状态 <>9 order by id desc";
						  	}
...
//              				}
					  			...
					  			<tr>
                					...
                					<td class="numeric"><a href="rjxg.php?ajh=<?php echo $row["案卷号"];?>" target="_blank"><?php echo $row["案卷号"];?></a></td>
                					<td class="numeric" style="width:200px;"><?php echo $row["软件名称"]; ?></td>
                					<td class="numeric" style="width:200px;"><?php echo $row["申请人"]; ?></td>
                					<td class="numeric"><?php echo $row["案源人"]; ?></td>
                					<td class="numeric"><?php echo $row["代理人"]; ?></td>
                					<td class="numeric" style="width:100px;"><?php echo $row["申请号"];?></td>
                					<td class="numeric" style="width:100px;"><?php echo $row["申请日期"];?></td>
                					<?php
                						if($row["状态"]==0){
                					?>
                					...
                					<?php
                						if($row["状态"]==2){
                					?>
                						<td class="numeric">删除</td>
                					<?php
                						}  
                					?>
                					<td class="numeric" style="width:100px;"><?php echo $row["登记号"];?></td>
                				</tr>
                    				<?php
					  			}
                    		}		
...
<!--结案，恢复，删除-->
<script src="../../../js/software_action.js"></script>
<script>
