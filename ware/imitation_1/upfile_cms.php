...
<body>
	<div align="center">
		<div id="my_form">
			<input type="text" id="data_0" value="<?php echo $_GET['data_0']; ?>"  />
			<table>
				<tr>
...
//			tmp_td_2.appendChild(tmp_button);
	...
	document.getElementById("uploading").addEventListener("click",function(){
		var data_0_v = document.getElementById("data_0").value;
		fd_file.append("flag","uploadfile_cms");
		fd_file.append("data_0",data_0_v);
		if(file_num > 1){
			$.ajax({
				type:"POST",
				url:"upfile_ajax.php",
