...
//  获取对应的数据
	...
	if($result->num_rows>0){
		...
		exit('<script type="text/javascript">alert("文件保存失败！");location.href="works.php";</script>');
	}
...
//							echo '保存成功';
		           ...
		           exit('<script type="text/javascript">alert("操作成功！");</script>');
...
//		        echo "上传失败";
              exit('<script type="text/javascript">alert("未选择文件！");</script>');
		    }
