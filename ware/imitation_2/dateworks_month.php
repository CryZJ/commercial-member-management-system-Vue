			    ...
			    <section class="panel">
			      <header class="panel-heading custom-tab">
				      <ul class="nav nav-tabs">
				        ...
				        <li class="active"><a href="#about-1">月日程</a></li>
				        ...
				        ?>
				        <input id="NORS" hidden="hidden" value="<?php echo $normal; ?>" /><!--勿删dateworks_month.php-->
				      </ul>
			      </header>
...
//                      		echo $order[2];
                    ...
                    <span class="dynamic-table" hidden="hidden" >1/asc/计划时间【正】</span>
                        ...
                        <tbody>
                        	<?php
                        		require'../../conn.php';
														$first_date = date("Y")."-".date("m")."-1";
														$end_date = date("Y")."-".date("m")."-".date("t");
														if($admin){
                        			$sql = "select id,用户id,事件名,事件时间,状态,备注  from 日程设置 where 事件时间 BETWEEN '".$first_date."' and '".$end_date."' and 状态=0 and 删除状态=0 ";
														}else{
                        			$sql = "select id,用户id,事件名,事件时间,状态,备注  from 日程设置 where 用户id='".$userid."' and 事件时间 BETWEEN '".$first_date."' and '".$end_date."' and 状态=0 and 删除状态=0 ";
														}
