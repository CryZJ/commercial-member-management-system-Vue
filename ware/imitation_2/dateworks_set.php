			    ...
			    <section class="panel">
			      <header class="panel-heading custom-tab">
				      <ul class="nav nav-tabs">
				        ...
				        <li class="active"><a href="#about-1">逾期日程</a></li>
...
//                      		echo $order[2];
                    ...
                    <span class="dynamic-table" hidden="hidden" >1/asc/计划时间【正】</span>
	                        ...
	                        <tr>
	                            ...
	                            <?php if($admin){echo "<th class='numeric'>创建人</th>";} ?>
                        ...
                        <tbody>
                        	<?php
                        		require'../../conn.php';
														if($admin){
                        			$sql = "select id,用户id,事件名,事件时间,状态,备注  from 日程设置 where 事件时间<'".date('Y-m-d')."' and 状态=0 and 删除状态=0 ";
														}else{
                        			$sql = "select id,用户id,事件名,事件时间,状态,备注  from 日程设置 where 用户id='".$userid."' and 事件时间<'".date('Y-m-d')."' and 状态=0 and 删除状态=0 ";
														}
				                		...
				                		if($result->num_rows>0){
				                            ...
				                            <?php if($admin){echo "<td class='numeric'>".$yhm."</td>";} ?>
...
<!--页面响应-->
<script src="../../js/imitation_2/dateworks_set.js"></script>
