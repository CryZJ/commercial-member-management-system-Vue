			    ...
			    <section class="panel">
			      <header class="panel-heading custom-tab">
				      <ul class="nav nav-tabs">
				        ...
				        <li class="active"><a href="#about-1">未完成日程</a></li>
				        ...
				        ?>
				        <input id="NORS" hidden="hidden" value="<?php echo $normal; ?>" /><!--勿删dateworks_undone.php-->
				      </ul>
			      </header>
                    ...
                    <span class="dynamic-table" hidden="hidden" >1/asc/计划时间【正】</span>
                        ...
                        <tbody>
                        	<?php
                        		require'../../conn.php';
														if($admin){
                        			$sql = "select id,用户id,事件名,事件时间,状态,备注  from 日程设置 where 状态=0 and 删除状态=0 ";
														}else{
                        			$sql = "select id,用户id,事件名,事件时间,状态,备注  from 日程设置 where 用户id='".$userid."' and  状态=0 and 删除状态=0 ";
														}
