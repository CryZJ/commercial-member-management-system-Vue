	    ...
	    <div  class="col-sm-12">
	        <section class="panel">
	            <header class="panel-heading">
					...
					<input id="button_save" type="button" value="保存信息" onclick="save_send(document.all.tabUserInfo)" />
	           ...
	           <div class="panel-body" style="width:98%;  overflow:auto; solid #000000;">
	                ...
	                <tbody >
            			...
            			<tr>
            				<td><input type="checkbox" id="" value="" name="" /></td>
            				<td><input style="width:100px;" type="text" id=""  name="" /></td>
            				<td><input style="width:100px;" type="text" id=""  name="" /></td>
