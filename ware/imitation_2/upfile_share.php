...
<body>
	<div align="center">
		<div id="my_form">
			<input id="ajax_flag" type="text" hidden="hidden" value="<?php echo $_GET['ajax_flag']; ?>" />
			<table>
				<tr>
...
//			tmp_td_2.appendChild(tmp_button);
	...
	document.getElementById("uploading").addEventListener("click",function(){
		var ajax_flag = document.getElementById("ajax_flag");
		var int_file = document.getElementById("int_file").files;
		fd_file.append("flag",ajax_flag.value);
