        ...
        <section class="panel">
            <header class="panel-heading text-center">
            	...
            	<span class="tools pull-right">
				    <a class="btn fa fa-power-off" onclick="window.close();">取消本次生成通知并关闭页面</a>
				</span>
            </header>
            <div class="panel-body text-center">
            	<iframe name="costnotice" id="costnotice" src=""></iframe>
          	</div>
       	</section>
        </div>
        </div>
...
<script type="text/javascript">
	if(typeof(Storage) !== "undefined"){
		...
		$("#costnotice").attr("src","yearcost_notice_child.php?index="+localStorage.index);
