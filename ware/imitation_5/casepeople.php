    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="active"><a href="../imitation_5/casepeople.php">案源人管理</a></li>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="casepeopleSave.php" class="form-horizontal " method="post">
                                            			<input type="text" hidden name="idnum" value="0"></input>
                                            			<table>
																					           <tbody>
																					           				<tr>
																					           					<td>编号：</td><td><input type="text" name="bh" id="" /></td>
																					           				</tr>
																					           				<tr height="5px"></tr>
																					                  <tr>
																													  ...
																													  <tr height="5px"></tr>
																													  <tr>
																													  	<td >入职日期: </td><td colspan="2"><input class="default-date-picker" readonly type="text" name="rzrq" id="" /></td>
																													  </tr>
																													  <tr height="5px"></tr>
																													  <tr>
																													  	<td >离职日期: </td><td colspan="2"><input class="default-date-picker" readonly type="text" name="lzrq" id="" /></td>
																													  </tr>
																											</tbody>
																					          </table>
																					          <br />
						        ...
						        <table  class="display table table-bordered table-striped" id="dynamic-table">
								        	<thead>
										        <tr> 
										            ...
										            <th>入职日期 </th>
										            <th>离职日期 </th>
										            <th style="overflow: hidden;text-overflow: ellipsis;">备注</th>
										           <!--<?php 
						        		...
						        		if($result->num_rows > 0){
						        			while($row = $result->fetch_assoc()){
						        				echo "<tr>";
						        					...
						        					echo "<td>".$row["入职日期"]."</td>";
						        					echo "<td>".$row["离职日期"]."</td>";
						        					echo "<td style='overflow:hidden;text-overflow:ellipsis;'>".$row["备注"]."</td>";
//														if($userid=='admin'){
//																echo "<td><a data-toggle='modal' href='#myModal".$row["编号"]."'>点击</a></td>";
//															}
						        				echo "</tr>";
						        				//创建小窗口
						        				...
						        				echo "<form action='casepeopleSave.php' class='form-horizontal ' method='post'>";
