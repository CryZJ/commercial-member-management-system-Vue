...
<body>
	<div>
		<div id="my_form">
			...
			<input type="text" id="idflag" value="<?php echo $_GET['idflag']; ?>" hidden="hidden" />
			<div>
				<table>
				<tr>
...
//			tmp_html +='<td><input type="text" placeholder="请填写文件描述" /></td>';
	...
	document.getElementById("uploading").addEventListener("click",function(){
		...
		var idflag_v = document.getElementById("idflag").value;
...
//			fd.append("des",inp[0].value);
			...
			fd.append("fileflag",idflag_v);
			fd.append("flag","changefile_2");
