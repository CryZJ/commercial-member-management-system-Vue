								...
								<table class="display table table-bordered table-striped" id="tab_3">
									...
									<tbody id="file_list">
										<?php
											...
											$sql_file = "SELECT id,文件路径,描述,上传时间,上传人  FROM 申请人文件 WHERE 申请人id='".$ssid."' AND 删除状态='0'";
											$result_file = $conn->query($sql_file);
//												$sql_name="SELECT 申请人 FROM 申请人 WHERE id='".$ssid."'";
//												$sql_name="SELECT b.`姓名` FROM 申请人文件 a, `联系人` b WHERE a.`申请人id`=121 AND a.`申请人id`=b.`申请人id`";
//												$sql_name="SELECT b.`姓名` FROM 申请人文件 a, `联系人` b WHERE a.`申请人id`='".$ssid."' AND a.`申请人id`=b.`申请人id`";
										$sql_name="SELECT 上传人 FROM 申请人文件  WHERE id='".$ssid."'";
														$result_name = $conn->query($sql_name);
														$row_name = $result_name->fetch_assoc();
														$sqrname=$row_name['上传人'];
												echo $sqrname;
										...
										?>
													<tr>
														...
														<!--<td><?php echo	$sqrname;?></td>-->
														<td><?php echo $row3['上传人']; ?> </td>
														<!--<td><?php echo $user ?></td>-->
													</tr>
										<?php			
												}
