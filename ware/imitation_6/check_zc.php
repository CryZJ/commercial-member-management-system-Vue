            ...
            <div class="panel-body" id="SA">
              		<div class="form-horizontal " id="my_form2">
					 		<div class="form-group">
                                <label class="control-label col-md-2 col-xs-2">支出项目：</label>
                                <div class="col-md-6 col-xs-8">
                                    <input class="form-control form-control-inline input-medium"   type="text"  />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-xs-2">金额：</label>
                                <div class="col-md-6 col-xs-8">
                            ...
                            <div class="form-group" style="display: none;">
                                <label class="control-label col-md-2 col-xs-2">支付方式：</label>
                                <div class="col-md-6 col-xs-8">
                                	<input class="form-control form-control-inline input-medium" id="payway_inp2"  />
                                	<!--<select id="payway2">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-xs-2">支出日期：</label>
                                <div class="col-md-6 col-xs-8">
                                    <input class="form-control form-control-inline input-medium" type="date" value="<?php echo date("Y-m-d"); ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-xs-2">付款人：</label>
                                <div class="col-md-6 col-xs-8">
                                    <input class="form-control form-control-inline input-medium"   />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-xs-2">收款人：</label>
                                <div class="col-md-6 col-xs-8">
                                    <input class="form-control form-control-inline input-medium"   />
                                </div>
                            </div>
                	...
                	<div class="modal-footer" align="center">
	                    	...
	                    	<button id="save_add2" class="btn btn-primary" type="button">修改</button>
...
//			file_self.innerHTML = data[7]+'&nbsp;<a class="btn btn-primary" target="_self" href="Downloadfile.php?filename=../../'+data[8]+'">下载</a> <button class="btn btn-danger" onclick="Chang_file()">替换</button>';
		},
...
//		var myid = document.getElementById("myid").value;
		file_id = btn_doc.name;
		if(confirm("是否确认替换文件？")){
			myurl = "change_file.php?id="+file_id;
	...
	//添加收入记录保存
	var save_add = document.getElementById("save_add2");
