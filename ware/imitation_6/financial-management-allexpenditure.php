	        		...
	        		<section class="panel">
	        			<header class="panel-heading custom-tab">
		             		<ul class="nav nav-tabs">
		             			...
		             			<li class="about-7 active"><a href="#about-7" data-toggle="tab"><i class="fa fa-align-justify"></i>总支出记录</a></li>
				        ...
				        <div class="tab-content">
                			...
                			<section id="unseen">
				        		...
				        		<table class="display table table-bordered table-striped" id="dynamic-table_6">
						        	<thead>
						        		<th> <input type="checkbox" onclick="Slect_All('dynamic-table_6',this)" /> </th>
							            <th>支出项目</th>
							            <th>金额</th>
							            <th>支出日期</th>
							            <th>收款人</th>
						        ...
						        <div>
							        <table class="display table table-bordered table-striped">
							        	...
							        	<tbody id="tab_monthcount_zc_ALL">
...
<script src="../../js/imitation_6/financial-management_allexpenditure.js"></script>
<script>
	//设置排序
