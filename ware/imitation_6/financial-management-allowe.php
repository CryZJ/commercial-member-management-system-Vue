	        		...
	        		<section class="panel">
	        			<header class="panel-heading custom-tab">
		             		<ul class="nav nav-tabs">
		             			...
		             			<li class="about-8 active"><a href="#about-8" data-toggle="tab"><i class="fa fa-align-justify"></i>总欠费记录</a></li>
				        	...
				        	<section id="unseen">
				        		<header>
			                        ...
			                        <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button" name="MenuO">
			                        	...
			                        	<span class="dynamic-table_7" hidden="hidden" ><?php echo $order[0].'/'.$order[1]; ?></span>
			                        </button>
				        		...
				        		<table class="display table table-bordered table-striped" id="dynamic-table_7">
						        	<thead>
							        	<th> <input type="checkbox" onclick="Slect_All('dynamic-table_7',this)" /> </th>
							            <th>客户名称</th>
							            <th>项目内容</th>
							            <th>总费用</th>
							            <th>规费</th>
						        ...
						        <div>
							        <table class="display table table-bordered table-striped">
							        	...
							        	<tbody id="tab_monthcount_qf_ALL">
...
<script src="../../js/imitation_6/financial-management_allowe.js"></script>
