	        		...
	        		<section class="panel">
	        			<header class="panel-heading custom-tab">
		             		<ul class="nav nav-tabs">
				                ...
				                <li class="about-2 active"><a href="#about-2" data-toggle="tab"><i class="fa fa-align-justify"></i>月支出记录</a></li>
				        ...
				        <div class="tab-content">
                			...
                			<section id="unseen">
				        		<header>
				        			<button class="btn btn-primary" data-toggle="modal" href="#addModal2" >添加支出记录</button><!--onclick="Clear_Modal('my_form2','2,3')"-->
				        			<button class="btn btn-success export_Excel_zc">导出选中行Excel</button>
				        			<label>选择年月：</label><input placeholder="请选填年月" style="width: 100px;" id="select_Ymsr" list="sr_list" /><datalist id="sr_list"></datalist>
					        		<!-- /btn-group -->
			                        ...
			                        <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button" name="MenuT">
			                        	<?php 
			                        		require'../../conn.php';
			                        		//查询
			                        		$sqlO1 = "select 财务2 from 表格顺序 where 用户id = '".$userid."'";
			                        ...
			                        <ul role="menu" class="dropdown-menu checilck" id="MenuT" >
			                            ...
			                            <li><a href="#">金额【倒】</a></li>
			                            <li><a href="#">支付方式</a></li>
			                            <li><a href="#">支出日期【正】</a></li>
			                            <li><a href="#">支出日期【倒】</a></li>
			                        </ul>
			                    </div>
			                    <!-- /btn-group -->
		                    </header>
				        		<table class="display table table-bordered table-striped" id="dynamic-table_2">
						        	<thead>
						        		<th><input type="checkbox" onclick="Slect_All('dynamic-table_2',this)" /> </th>
							            <th>支出项目</th>
							            <th>金额</th>
							            <th>支出日期</th>
							            <th>收款人</th>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">支出记录添加</h4>
					</div>
					<div class="modal-body">
						<div class="form-horizontal " id="my_form2">
					 		<div class="form-group">
                                <label class="control-label col-md-4">支出项目：</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-11">
                                    <input class="form-control form-control-inline input-medium" onkeyup="value=value.replace(/[^-?\d*\.?\d]/g,'')"  placeholder="请输入数字"  type="text"  />
                                </div>
                            </div>
                            <div class="form-group" style="display: none;">
                                ...
                                <div class="col-md-6 col-xs-11">
                                	...
                                	<input type="text" id="payway_inp2" value="现金" hidden="hidden" />-->
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">支出日期：</label>
                                <div class="col-md-6 col-xs-11">
                                    <input class="form-control form-control-inline input-medium" type="date" value="<?php echo date("Y-m-d"); ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">付款人：</label>
                                <div class="col-md-6 col-xs-11">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-11">
                                    <input class="form-control form-control-inline input-medium" type="file" id="file_zc" multiple="multiple" />
                                </div>
                            </div>
                             <div class="form-group">
	                    ...
	                    <div class="modal-footer" align="center">
	                    	<button class="btn btn-danger" onclick="Clear_Modal('my_form2','2,3')">清除</button>
	                    	<button id="save_add2"  class="btn btn-primary" type="button" onclick="Savenewdata_zc(this)">保存</button>
...
<script src="../../js/imitation_6/financial-management_monthexpenditure.js"></script>
<script>
	//设置排序
