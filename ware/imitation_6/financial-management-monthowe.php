	        		...
	        		<section class="panel">
	        			<header class="panel-heading custom-tab">
		             		<ul class="nav nav-tabs">
				                ...
				                <li class="about-5 active"><a href="#about-5" data-toggle="tab"><i class="fa fa-align-justify"></i>月欠费记录</a></li>
				        ...
				        <div class="tab-content">
				        	...
				        	<section id="unseen">
				        		<header>
				        			<button class="btn btn-primary" data-toggle="modal" href="#addModal3" >添加欠费记录</button><!--onclick="Clear_Modal('my_form','6,7')"-->
				        			<button class="btn btn-success exp_Excel_qf">导出选中行Excel</button>
				        			<label>选择年月：</label><input placeholder="请选填年月" style="width: 100px;" id="selected_value_qf" list="Select_qf"><datalist id="Select_qf"></datalist>
					        		<!-- /btn-group -->
				        		...
				        		<table class="display table table-bordered table-striped" id="dynamic-table_4">
						        	<thead>
							        	<th> <input type="checkbox" onclick="Slect_All('dynamic-table_4',this)" /> </th>
							            <th>客户名称</th>
							            <th>项目内容</th>
							            <th>总费用</th>
							            <th>规费</th>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">欠费记录添加</h4>
					</div>
					<div class="modal-body">
						<div class="form-horizontal " id="my_form3">
					 		<div class="form-group">
                                <label class="control-label col-md-4">客户名称：</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="kh_2" class="form-control form-control-inline input-medium"   type="text" onclick="select_kh(this.id)" readonly="readonly" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-11">
                                    <input id="ayr_2" class="form-control form-control-inline input-medium"   type="text" onclick="select_ayr(this.id)" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">代理人：</label>
                                <div class="col-md-6 col-xs-11">
                                    <input id="dlr_2" class="form-control form-control-inline input-medium"   type="text" onclick="select_dlr(this.id)" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
	                    ...
	                    <div class="modal-footer" align="center">
	                    	<button class="btn btn-danger" onclick="Clear_Modal('my_form3','6,7')" >清除</button>
	                    	<button class="btn btn-primary" type="button" onclick="Savenew_data_qf(this)" >保存</button>
...
<script src="../../js/imitation_6/financial-management_monthowe.js"></script>
<script>
	//设置排序
