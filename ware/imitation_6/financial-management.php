	        		...
	        		<section class="panel">
	        			<header class="panel-heading custom-tab">
		             		<ul class="nav nav-tabs">
		             			<li class="about-1 active"><a href="#about-1" data-toggle="tab"><i class="fa fa-align-justify"></i>总收入记录</a></li>
				        ...
				        <div class="tab-content">
				        	...
				        	<section id="unseen">
				        		<header>
				        			...
				        			<button class="btn btn-success exp_Excel_sr_ALL">导出选中行Excel</button>
					        		<!-- /btn-group -->
				        		...
				        		<table class="display table table-bordered table-striped" id="dynamic-table_5">
						        	<thead>
							        	  <th><input type="checkbox" onclick="Slect_All('dynamic-table_5',this)" /></th>
							            <th>客户名称</th>
							            <th>项目内容</th>
							            <th>总费用</th>
							            <th>规费</th>
						        ...
						        <div>
							        <table class="display table table-bordered table-striped">
							        	...
							        	<tbody id="tab_monthcount_sr_ALL">
...
<!--<script src="../../js/imitation_6/financial-management_2.js"></script>-->
<script src="../../js/imitation_6/financial-management-allincome.js"></script>
<script>
	//设置排序
