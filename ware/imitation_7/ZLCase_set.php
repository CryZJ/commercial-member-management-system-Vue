        	...
        	<div class="row">
	        	<div class="col-sm-12">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#about-1" data-toggle="tab"><i class="fa fa-user"></i>专利类型管理</a></li>
                  </ul>
                </header>
                <div class="panel-body">
                    ...
                    <section id="unseen">
                    	<table class="display table table-bordered table-striped" id="dynamic-table">
	                        <thead>
	            				<tr>
                					<th style="width: 50px;"><input type="checkbox" id="sel_all" /></th>
                        	...
                        	<tbody id="tab_info">
                        		<?php
                        			require("../../conn.php");
									$sql = "SELECT id,类型,创建人id,创建时间  FROM 专利类型设置 where 状态=0";
									$result = $conn->query($sql);
									if($result->num_rows>0){
										while($row = $result->fetch_assoc()){
											$sql2 = "SELECT 名称  FROM 用户 where id='".$row['创建人id']."'";
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">专利类型添加</h4>
					</div>
...
<!--个人添加页面响应-->
<script src="../../js/imitation_7/ZLCase.js"></script>
<!--about 常态-->
