    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
			 <li class="menu-list nav-active"><a href="index.php"><i class="fa fa-laptop"></i><span>案件管理</span></a>
				<ul class="sub-menu-list">
                <li class="active"><a href="index.php">专利案件</a></li>
                <li><a href="ware/imitation_1/blogo_case/blogo.php">商标案件</a></li>
                <li><a href="ware/imitation_1/software_case/software.php">软件案件</a></li>
                <li><a href="ware/imitation_1/works_case/works.php">著作案件</a></li>
                <li><a href="ware/imitation_1/customs_case/customes.php">海关备案</a></li>
              </ul>
             </li>
             	<li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>OA办公</span></a>
             		<ul class="sub-menu-list">
             			<li><a href="ware/imitation_2/mailmas.php">文件收发</a></li>
             			<li><a href="ware/imitation_2/exdelmas.php">快递收发</a></li>
             			<li><a href="ware/imitation_2/casemark.php">案件登记</a></li>
             			<li><a href="ware/imitation_2/dateworks.php">日程管理</a></li>
             			<li><a href="ware/imitation_2/ClieMag.php">客户管理</a></li>
             		</ul>
             	</li>
            	<li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>费用管理</span></a>
            		<ul class="sub-menu-list">
		                <li><a href="ware/imitation_3/cost.php">专利其他费用</a></li>
		                <li><a href="ware/imitation_3/yearcost.php?flag=none&v=0">专利年费管理</a></li>
		                <li><a href="ware/imitation_3/cost_zl.php">其他费用管理</a></li>
	                </ul>
              	</li>
             	<li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>人员管理</span></a>
             		<ul class="sub-menu-list">
	                <li><a href="ware/imitation_5/client.php"> 申请人管理</a></li>
	                <li><a href="ware/imitation_5/agent.php">账号管理</a></li>
	               </ul>
	            </li>
	            <?php
	            	require'conn.php';
	            	...
	            	if($sysset == 1){
	            		...
	            		<li class="menu-list"><a href="#"><i class="fa fa-laptop"></i> <span>系统设置</span></a>
			                <ul class="sub-menu-list">
				                <li><a href="ware/imitation_7/bank_set.php">银行账户设置</a></li>
					            	<li><a href="ware/imitation_7/fare_set.php">专案费用名设置</a></li>
					            	<li><a href="ware/imitation_7/BLogoC_set.php">商标代理人设置</a></li>
					            	<li><a href="ware/imitation_7/Circuit_set.php">流程设置</a></li>
					            	<li><a href="ware/imitation_7/ZLCase_set.php">专利类型设置</a></li>
					            </ul>
			            </li>
	            		<?php
	            	}
	            	if($fareco == 1){
	            		?>
	            		 <li class="menu-list">
	            		 	<a href="#"><i class="fa fa-laptop"></i> <span>财务管理</span></a>
		                	<ul class="sub-menu-list">
				                <li><a href="ware/imitation_6/financial-management.php">财务管理</a></li>
				            	</ul>
		                </li>
	            		<?php
	            	}
    ...
    <div class="main-content" >
    	...
    	<div class="wrapper" >
        		...
        		<section class="panel">
        			<header class="panel-heading custom-tab">
		              <ul class="nav nav-tabs">
		              	<!--在此处的li样式中添加active-->
		                <li class="about-1"><a href="#about-1" data-toggle="tab"><i class="fa fa-user"></i>专利案件</a></li>
		                <!--<li class="about-2"><a href="#about-2" data-toggle="tab"><i class="fa fa-user"></i>无效案件</a></li>-->
        	...
        	<div class="tab-content">
		        <div class="tab-pane" id="about-1"><!--在此处的div样式中添加active-->
                  <section id="unseen">
			            <!-- button list -->
				          	<div>
				              <a href="ware/imitation_1/new_case/new case 00.php" ><button class="btn btn-success" type="button">新建</button></a><!--ware/imitation_1/new_case/new case 00.php-->
...
//									}
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table" >
		                  <thead>
		                    <tr>
			                    <th class="numeric sorting_desc_disabled"><input onchange="selectAll('dynamic-table',this)" type="checkbox" /></th>
		                  ...
		                  <tbody>
                            <?php
								...
								if($dlrbh != null && $ayrbh != null){
															if($admin == 1){
																$sql="select id,案卷号,案源人,代理人,类型,专利名称,冻结状态,状态,申请号,申请人id,申请日   from `专利信息` b where b.冻结状态<>'3' and 状态<>9";
															}else{
																$sql="select id,案卷号,案源人,代理人,类型,专利名称,冻结状态,状态,申请号,申请人id,申请日   from `专利信息` b where b.冻结状态<>'3' and b.冻结状态<>'2' and 状态<>9";
															}
//									if($admin == 1){//最高权限可以看见所有案件
//                      				$sql="select 案卷号,案源人,代理人,类型,专利名称,冻结状态,状态,申请号,申请人,申请日   from `专利信息` b where b.冻结状态<>'3' and b.冻结状态<>'2' and 状态<>9 order by ".$order." ";
                        				$result = $conn->query($sql);
		                        		if($result->num_rows > 0){
		                        			while($row = $result->fetch_assoc()){
		                        	...
		                        	?>
	                				<tr>
	                					<td><label><input class="box_son" name="Fruit[]" type="checkbox" value="0" id="<?php echo $row["id"];?>"/></label></td>
				...
				<div class="tab-pane" id="about-2">
                  <section id="unseen">
                  	<div>
				        <a href="ware/imitation_1/new_wx/new case 02.php" ><button class="btn btn-success" type="button">新建</button></a><!--ware/imitation_1/new_case/new case 00.php-->
						<button class="btn btn-primary" type="button" data-toggle="modal" href="#addModal2" >结案</button>
						<button class="btn btn-primary" type="button" onclick="huif('dynamic-table_2')">恢复</button>
							<?php
//								if($admin==1||$lcczy==1){
							?>
...
//								}
	            	...
	            	<button class="btn btn-primary" onclick="Export_someExcel('dynamic-table_2','phpexcel/my_test/wx_export_some.php')">导出选中行Excel清单</button>
		            <!-- button list end -->
		            <!-- button list end -->
		            	<!-- /btn-group -->
		            	<div class="btn-group" style="float: right;" >
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table_2" >
		                  <thead>
		                    <tr>
			                    <th class="numeric"><input onchange="selectAll('dynamic-table_2',this)" type="checkbox" /></th>
			                    <th class="numeric">案卷号</th>
			                    <th class="numeric">类型</th>
			                    <th class="numeric">申请号</th>
			                    <th class="numeric" hidden="hidden">申请日</th>
			                    <th class="numeric">申请人</th>
			                    <th class="numeric">专利名称</th>
			                    <th class="numeric">案源人</th>
			                    <th class="numeric">代理人</th>
...
//									if($admin == 1){
															if($admin == 1){
																$sql="select id,b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人id  from `专案_无效` b where b.冻结状态<>'3' and 状态<>9 group by b.`案卷号`";
															}else{
																$sql="select id,b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人id  from `专案_无效` b where b.冻结状态<>'3' and b.冻结状态<>'2' and 状态<>9 group by b.`案卷号`";
															}
//                      				$sql="select b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人  from `专案_无效` b where b.冻结状态<>'3' and b.冻结状态<>'2' and 状态<>9 group by b.`案卷号`";
                        				$result = $conn->query($sql);
		                        		if($result->num_rows >= 0){
		                        			while($row = $result->fetch_assoc()){
		                        				$dlr = substr($row["案卷号"],7,2);
		                        				...
		                        				<tr>
		                        					<td><label><input class="box_son" name="Fruit[]" type="checkbox" value="0" id="<?php echo $row["id"];?>" /></label></td>
		                        					<td class="numeric"><a href="ware/imitation_1/new_wx/case_info.php?ajh=<?php echo $row["案卷号"];?>" target="_blank" ><?php echo $row["案卷号"];?></a></td>
		                        					<td class="numeric"><?php echo $row["类型"];?></td>
		                        					<td class="numeric"><?php echo $row["申请号"];?></td>
		                        					<td class="numeric" hidden="hidden"></td>
		                        					<td class="numeric"><?php echo $SQRMes;?></td>
		                        					<td class="numeric"><?php echo $row["专利名称"];?></td>
		                        					<td class="numeric"><?php echo $row["案源人"];?></td>
		                        					<td class="numeric"><?php echo $row["代理人"];?></td>
           	...
           	<div class="tab-pane" id="about-3">
                  <section id="unseen">
                  	<div>
		              	<a href="ware/imitation_1/new_fs/new_case.php" ><button class="btn btn-success" type="button">新建</button></a><!--ware/imitation_1/new_case/new case 00.php-->
...
//							}
	            ...
	            <button class="btn btn-primary" onclick="Export_someExcel('dynamic-table_3','phpexcel/my_test/fs_export_some.php')">导出选中行Excel清单</button>
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table_3">
                        <thead>
                        <tr>
                            <th><input type="checkbox" onchange="selectAll('dynamic-table_3',this)" /></th>
                            <th class="numeric">案卷号</th>
                            <th class="numeric">类型</th>
                            <th class="numeric">申请号</th>
                            <th class="numeric" hidden="hidden">申请日</th>
...
//							if($admin == 1){
                				if($admin == 1){
													$sql="select id,b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人id  from `专案_复审等` b where b.冻结状态<>'3' and 状态<>9 group by  b.`案卷号`";
												}else{
													$sql="select id,b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人id  from `专案_复审等` b where b.冻结状态<>'3' and b.冻结状态<>'2' and 状态<>9 group by  b.`案卷号`";
												}
                				$result = $conn->query($sql);
                        		if($result->num_rows >= 0){
                        			while($row = $result->fetch_assoc()){
           ...
           <div class="tab-pane" id="about-4">
                  <section id="unseen">
                  	<div>
		              	<a href="ware/imitation_1/new_yearcost/new case 01.php" ><button class="btn btn-success" type="button">新建</button></a><!--ware/imitation_1/new_case/new case 00.php-->
...
//							}
	            ...
	            <button class="btn btn-primary" onclick="Export_someExcel('dynamic-table_4','phpexcel/my_test/nf_export_some.php')">导出选中行Excel清单</button>
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table_4">
                        <thead>
                        <tr>
                            <th><input type="checkbox" onchange="selectAll('dynamic-table_4',this)" /></th>
                            <th class="numeric">案卷号</th>
                            <th class="numeric">类型</th>
                            <th class="numeric">申请号</th>
                            <th class="numeric" hidden="hidden">申请日</th>
...
//								if($admin == 1){
                    		if($admin == 1){
													$sql="select id,b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人id,原案卷号  from `专案_年费` b where b.冻结状态<>'3' and 案件状态<>9 group by  b.`案卷号`";
												}else{
													$sql="select id,b.案卷号,b.案源人,b.代理人,类型,专利名称,冻结状态,b.状态,申请号,申请人id,原案卷号  from `专案_年费` b where b.冻结状态<>'3' and b.冻结状态<>'2' and 案件状态<>9 group by  b.`案卷号`";
												}
            ...
            <!--作废案件-->
				...
				//									}
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table_5">
                        <thead>
                        <tr>
                            <th style="width: 20%;"  ><input type="checkbox" onchange="selectAll('dynamic-table_5',this)" /></th>
                            <th class="numeric" style="width: 20%;">案卷号</th>
                            <th class="numeric" style="width: 20%;">案源人</th>
                            <th class="numeric" style="width: 20%;">代理人</th>
                            <th class="numeric" style="width: 20%;word-wrap: break-word;">申请人</th>
                            <th class="numeric" style="width: 20%;">创建时间</th>
                            <th class="numeric" style="width: 20%;">创建人</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                					require("conn.php");
													if($dlrbh != null && $ayrbh != null){
														$sql="select id,案卷号,案源人,代理人,创建时间,创建人,申请人id from 专利信息 where 状态 = 9 and 冻结状态<>2 and 冻结状态<>3 ";
	                    			$result = $conn->query($sql);
                        		if($result->num_rows > 0){
                        			while($row = $result->fetch_assoc()){
                        				//获取申请人id
